...
namespace Microplate.Utils
{
    ...
    /// which uses the <see cref="ISerializable"/> interface. 
    ...
    public sealed class XmlFormatter : IFormatter
    {
        ...
        public object Deserialize(Stream serializationStream)
        {
            ...
            return Deserialize(serializationStream, type);
        }
        ...
        /// <summary>
        /// Gets all the serializable members of an object and return an enumerable collection.
        /// </summary>
